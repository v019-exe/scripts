...
function Generar-Reporte {
    ...
    Add-Content -Path $reportPath -Value ($netInfo | Out-String)
    ...
    Add-Content -Path $reportPath -Value ($tcpConn | Out-String)
    ...
    Add-Content -Path $reportPath -Value ($processes | Out-String)
    ...
    Add-Content -Path $reportPath -Value ($routing | Out-String)
